...
class __TwigTemplate_f53003ae66c04bbd5d50bd78aa2d016de133ec48c06ec3a987cfd38a17def57b extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["program"]) {
            ...
            <a href=\"";
            // line 11
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_show", ["id" => twig_get_attribute($this->env, $this->source, $context["program"], "id", [], "any", false, false, false, 11)]), "html", null, true);
...
";
    ...
    {
        return array (  148 => 17,  145 => 16,  138 => 14,  122 => 11,  118 => 10,  112 => 9,  109 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    {% for program in programs %}
        <div>
            ...
            <p>{{ program.summary }}</p>
            <a href=\"{{ path(\"program_show\", { id: program.id }) }}\">Voir la fiche</a>
        </div>
    {% else %}
...
{% endblock %}
", "program/index.html.twig", "/home/wilder/Bureau/Ajax - Recherche autocomplete/templates/program/index.html.twig");
    }
}
